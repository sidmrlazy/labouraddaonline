    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
                ...
                <form class="p-4 p-md-5 border rounded la-p" action="provincial_user_ereg" method="post" style="background-color: #fff;">
                    <!-- 1st Section Start -->
                    <div class="container">
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label for="dealer_mobile">Re-Enter your Mobile Number</label>
                                <input type="number" class="form-control numberonly" name="provi_mobile" minlength="10" maxlength="10" pattern="[6789][0-9]{9}">
                            </div>
