...
<section class="site-section">
	<div class="container">
		<div class="row mb-5">
			...
			<div class="col-md-6 col-lg-4 mb-5">
				<iframe class="img-fluid rounded mb-4" width="auto" height="auto" src="https://www.youtube.com/embed/M7SyK-UD8TQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			...
			<!-- <div class="col-md-6 col-lg-4 mb-5">
				<a href="blog-single.html"><img src="images/la-gallery/yourstory.png" alt="Image" class="img-fluid rounded mb-4"></a>
				<h3><a href="#" class="text-black">[Startup Bharat] From building robots to helping daily-wage labourers, these startups are charting their own journey</a></h3>
...
<section class="site-section" style="margin-top: -10rem;">
	<div class="container">
		<div class="row mb-5">

			<div class="col-md-6 col-lg-4 mb-5">
				<a href="https://sociable.co/business/labouradda-india-unorganized-labor-force/" target="_blank">
					<img src="images/la-gallery/sociable.png" alt="Image" class="img-fluid rounded mb-4"></a>
				<h3><a href="https://sociable.co/business/labouradda-india-unorganized-labor-force/" target="_blank" class="text-black">Inside Labouradda’s plan to provide work for India’s 437M unorganized labor force</a></h3>
				<div>Oct. 17, 2018 <span class="mx-2">|</span> <a href="#">By Tim Hinchliffe</a></div>
			</div>

			<div class="col-md-6 col-lg-4 mb-5">
				<a href="https://yourstory.com/2019/02/startup-bharat-robots-labourers-health-food-krhcfirhwk" target="_blank"><img src="images/la-gallery/yourstory.png" alt="Image" class="img-fluid rounded mb-4"></a>
				<h3><a href="https://yourstory.com/2019/02/startup-bharat-robots-labourers-health-food-krhcfirhwk" target="_blank" class="text-black">[Startup Bharat] From building robots to helping daily-wage labourers, these startups are charting their own journey</a></h3>
				<div>28th Feb 2019 <span class="mx-2">|</span> <a href="#">By Sameer Ranjan</a></div>
			</div>

			<div class="col-md-6 col-lg-4 mb-5">
				<a href="https://www.dnaindia.com/ahmedabad/report-an-app-tested-in-ahmedabad-set-to-disrupt-labour-market-in-up-2635356" target="_blank"><img src="images/la-gallery/dna.png" alt="Image" class="img-fluid rounded mb-4"></a>
				<h3><a href="https://www.dnaindia.com/ahmedabad/report-an-app-tested-in-ahmedabad-set-to-disrupt-labour-market-in-up-2635356" target="_blank" class="text-black">An app tested in Ahmedabad set to disrupt labour market in UP</a></h3>
