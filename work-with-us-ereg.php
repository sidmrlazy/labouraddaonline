...
//
                        $query = "SELECT dealer_mobile FROM dealer_web WHERE dealer_mobile='$dealer_mobile' limit 1 ";
                        $result = mysqli_query($connection, $query);
                        $row1=mysqli_fetch_assoc($result);
                        $number=$row1['dealer_mobile'];
                        if ($dealer_mobile==$number) {
                            $query = "SELECT * FROM dealer_web JOIN state ON dealer_web.dealer_state=state.state_id JOIN city ON dealer_web.dealer_city=city.city_id JOIN PinCode ON dealer_web.dealer_pincode=PinCode.Pincode WHERE dealer_web.dealer_mobile='$dealer_mobile' ";
                            ...
                            <form class="p-4 p-md-5 border rounded la-p" action="payment_screen" method="post"
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="number" class="form-control" id="email" name="dealer_mobile"
                                                   minlength="10" maxlength="10"
                                                   value="<?php echo $row1['dealer_mobile']; ?>">
                                        </div>


                                        <div class="form-group col-lg-6">
                                            <label for="dealer_category[]" style="font-size: 10px;">Select
                                                Category</label>
                                            <select class="selectpicker border rounded ui fluid dropdown"
                                                    multiple="multiple" id="job-type" data-style="btn-black"
                                                    data-width="100%" required="" data-live-search="true"
                                                    title="Select Your Category" name="dealer_category[]">
                                                <?php if (!empty($row1['dealer_category'])) { ?>
                                                    <option selected
                                                            value="<?php echo $row1['dealer_category']; ?>"><?php echo $row1['dealer_category']; ?></option>
                                                <?php } else { ?>
                                                    <option value="Labour/Mistri Contractor">Labour/Mistri Contractor
                                                    </option>
                                                    <option value="Tile Mistri Contractor">Tile Mistri Contractor
                                                    </option>
                                                    <option value="Electrician Contractor">Electrician Contractor
                                                    </option>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="job-title" required=""
                                                   name="dealer_fullname"
                                                   value="<?php echo $row1['dealer_fullname']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select name="dealer_state" class="form-control" id="state" required="">
                                                ...
                                                // if($row1['dealer_state'] == $row['state_id'])
                                                // {
                                                ?>
                                                <option selected
                                                        value="<?php echo $row1['dealer_state'] ?>"><?php echo $row1['state_name']; ?></option>
                                                <?php //} } }
                                                // else {
                                                // if($result->num_rows > 0){
                                                // while($row = $result->fetch_assoc()){
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select name="dealer_city" class="form-control" id="city" required="">
                                                ...
                                                <option selected
                                                        value="<?php echo $row1['dealer_city']; ?>"><?php echo $row1['city_name']; ?></option>
                                            </select>
                                        </div>
                                        <!-- 1st Section End -->
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select name="dealer_pincode" class="form-control" id="pincode" required="">
                                                ...
                                                <option selected
                                                        value="<?php echo $row1['dealer_pincode']; ?>"><?php echo $row1['Location']; ?></option>
                                            </select>
                                        </div>

                                        <div class="form-group col-lg-12">
                                            <label for="dealer_address" style="font-size: 10px;">Address</label>
                                            <input type="text" class="form-control" required="" name="dealer_address"
                                                   onFocus="geolocate()" id="autocomplete"
                                                   value="<?php echo $row1['dealer_address']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="password" class="form-control" placeholder="Min 6 Characters"
                                                   required="" name="dealer_password" minlength="6" id="dealer_password"
                                                   value="<?php echo $row1['dealer_password']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="password" class="form-control" required=""
                                                   name="dealer_confirm_password" minlength="6"
                                                   id="dealer_confirm_password"
                                                   value="<?php echo $row1['dealer_password']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <span style="font-size: 12px;">By clicking on submit you 'Agree' to the <a
                                                        href="tnc" target="_blank">Terms & Conditions</a></span>
