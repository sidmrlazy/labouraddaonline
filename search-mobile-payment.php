...
<?php include "razorpay-php/razorpay.php" ?>
    ...
    if($dealer_mobile) {
        ...
        if ($select_confirm) {
                            ...
                            <div class="col-lg-12 ml-auto la-content-about" style="margin-bottom: 100px;">
                                ...
                                <form action="payment_success?q=<?php echo $_POST['dealer_mobile']; ?>"
                                    ...
                                    <script
                                        ...
                                        data-key="rzp_live_ca8jKeFLeNxK6d"
                                        data-amount="29900"
                                        data-currency="INR"
            ...
            // header("Location:index");
             $msg_password = base64_encode("mobile number not found!");
            header("Location:payment-thekedaar?msg=$msg_password");
        }
        } 
        else {
            // header("Location:index");
    ...
    {
           header("Location:payment-thekedaar");
